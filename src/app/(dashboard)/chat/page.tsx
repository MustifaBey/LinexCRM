    ...
    if (selectedChannel?.id) {
      msgChannel = supabase
        ...
        .on(
          ...
          (payload: any) => {
            // Refetch messages silently to capture attachments, polls, or vote updates
              ...
              return (
                <div key={dateKey} className="space-y-4">
                  ...
                  {msgs.map((m) => {
                    ...
                    return (
                      <div key={m.id} className="flex items-start gap-3.5 hover:bg-card/5 p-1 rounded-xl transition-all group">
                        {/* Avatar */}
