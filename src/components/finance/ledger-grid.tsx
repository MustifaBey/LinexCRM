...
export function LedgerGrid({
  ...
  const handleDelete = async (id: string, fileToClean: string | null) => {
    if (!isAdmin) return;
    if (!window.confirm("Bu işlemi kalıcı olarak silmek istediğinizden emin misiniz?")) return;
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-4 font-medium text-foreground max-w-[200px] truncate select-all">
                        ...
                        {tx.invoice_number && (
                          <div className="text-[10px] text-muted-foreground font-mono mt-0.5 select-all">
                      ...
                      <td className="px-5 py-4 max-w-[160px] truncate">
                        {tx.client?.name ? (
                          <div className="flex items-center gap-1 text-foreground font-medium truncate select-all">
                            <Building className="w-3 h-3 text-burgundy shrink-0" />
                        ...
                        {tx.project?.name && (
                          <div className="flex items-center gap-1 text-[10px] text-muted-foreground font-medium mt-0.5 truncate select-all">
                      ...
                      {/* Type (Inline editable for Admin) */}
