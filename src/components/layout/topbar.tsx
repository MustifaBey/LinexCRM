...
export function Topbar({ onMenuClick, userProfile }: TopbarProps) {
  ...
  return (
    <>
      <header className="flex items-center h-16 px-4 lg:px-6 border-b border-border bg-background/80 backdrop-blur-sm flex-shrink-0 gap-4 relative z-50">
        {/* Mobile menu button */}
        <button
          onClick={onMenuClick}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={notifDropdownRef}>
            ...
            {/* Dropdown */}
            {notifDropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-80 rounded-xl bg-popover border border-border shadow-xl z-50 animate-in fade-in duration-100 flex flex-col overflow-hidden">
                {/* Header */}
          ...
          <div ref={menuRef} className="relative">
            <button
              ...
              className="flex items-center gap-2 hover:bg-muted/50 p-1.5 pr-3 rounded-full transition-colors outline-none"
            >
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-52 rounded-xl bg-popover border border-border shadow-xl py-1.5 z-50 animate-in fade-in duration-100">
